...
const Sprite = function (url, spriteSheetW, spriteSheetH, spriteSheetRows, spriteSheetCols, srcCurFrame, srcTotFrame, srcx, srcy, dx, dy, speed) {
  this.url = url
...
const player = new Sprite('./public/assets/images/sprites/hero.png', 640, 470, 5, 8, 0, 6, 0, 94, 0, 260, 3)
const ufo = new Sprite('./public/assets/images/sprites/ufo1/ufov2.png', 696, 210, 5, 12, 0, 12, 0, 0, 0, 10, 7)
const spotBeam = new Sprite('./public/assets/images/sprites/ufo1/ufov2.png', 696, 210, 5, 12, 0, 12)
const playerShooting = new Sprite('./public/assets/images/sprites/hero.png', 640, 470, 5, 8, 0, 8, 0, 0, 326, 260, 3)

const playerInjured = new Sprite('./public/assets/images/sprites/hero.png', 640, 470, 5, 8, 1, 7, 240, 282, 326, 260, 3)
